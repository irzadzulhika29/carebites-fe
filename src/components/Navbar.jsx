    ...
    <nav className="p-3 bg-white shadow-md">
      <div className="flex justify-between items-center px-5">
        ...
        <div className="hidden md:flex gap-4 text-[#00712D]">
          ...
          <Link
            to="/loginscreen"
            className="hover:scale-110 hover:bg-white hover:border hover:border-[#00712D] hover:text-[#00712D] bg-[#00712D] text-[#D5ED9F] px-4 py-2 rounded-full border border-transparent transition duration-300"
          >
            Sign In
          </Link>
        </div>
